...
import BG1 from '../assets/bannerBG.png';
import BG2 from '../assets/result.jpg';
...
function Banner(){
    ...
    <>
        <Header/>
        <br id="banner" /><br/><br/><br/>
        <Box id="banner" backgroundImage={BG1} backgroundPosition="bottom" backgroundRepeat="no-repeat" backgroundSize="100%" py="40">
            <Box display="flex" flexDirection="column" alignItems="left" ml={150}>
                <Heading width="40%" as="h1" size="2xl">
                    <Box fontWeight="black">
                    Yuk, Kenali Minat dan Bakatmu!!
                    </Box>
                </Heading>
                <Box width="40%" mt="6" fontWeight="medium">
                ...
                <Box mt="4">
                    ...
                    <>
                        <Button onClick={()=>navigate('/test-opening')} pr={5} fontSize="lg" color="black" variant='outline' background="#FFCD1D">
                            Ikuti Tes Sekarang
                        </Button>
                    </>
                    :
                    <>
                        <Button onClick={()=>navigate('/login')} pr={5} fontSize="lg" color="black" variant='outline' background="#FFCD1D">
                            Login
                        </Button>
                    </>
                    }
        ...
        <Box id="about" backgroundImage={BG2} backgroundRepeat="no-repeat" backgroundSize="100%" gap={50}>
            <Box 
            mx="80"
            background="white" 
            borderWidth="3px"
            ...
            boxShadow={'2xl'}
            padding={4}>
                <Box mx="10" my="10" display="flex" alignItems="center" justifyContent="space-around">
...
{/* <Box id="about" backgroundImage={BG2} backgroundRepeat="no-repeat" backgroundSize="100%">
